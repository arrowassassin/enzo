...
| 4 | **Enthusiast (T2)** | Tap-to-turn, auto-rotate, night jobs, BLE remote and keyboard, Beam, MOBI/AZW3, word cursor with highlights and notes, vocabulary builder, skim, search, series and collections, typography profiles, 2-bit anti-aliasing, tilt turn, profiles, stats calendar and streaks, flashcards, news, clock, Wikipedia, custom fonts, CJK packs, localisation. | — |
